 ...
 *
 * Contact form and information for reaching the organization.
 *
 * @component
 * @example
 * <Contact />
                ...
                <div className="flex items-center gap-3">
                  {["Twitter", "Instagram", "LinkedIn"].map((social) => (
                    <a
                      key={social}
                      href="#"
                      className="w-10 h-10 bg-gray-200 rounded-full flex items-center justify-center hover:bg-indigo-600 hover:text-white transition-colors text-gray-600"
                    >
                      {social[0]}
                    </a>
                  ))}
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    ...
                    className="w-full md:w-auto px-8 py-3 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
